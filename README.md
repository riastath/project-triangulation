...
- Για testing των αλγορίθμων, προστέθηκαν παράμετροι στα .json αρχεία data, data2, data3 στον φάκελο tests.
...
## Παρατηρήσεις για την αποτελεσματικότητα των αλγορίθμων
...
# Επιλογή παραμέτρων για τους αλγορίθμους
Για το local search, χρησιμοποιήθηκε αριθμός επαναλήψεων L = 50 διότι αποτελεί ένα καλό παράδειγμα για να ελεγχτεί η λειτουργία του, καθώς είναι σχετικά μεσαία τιμή. Για το simulated annealing, ομοίως επιλέχτηκε L = 50 και στα βάρη δώθηκαν τιμές 2.0 και 5.0, διότι υπάρχει μια σχετική ισορροπία μεταξύ τους - το α δεν είναι πολύ μικρό, το β δεν είναι πολύ μεγάλο, το οποίο οδηγεί σε πιο ομαλό υπολογισμό της ενέργειας για να συνεχιστούν οι δοκιμές καθώς η θερμοκρασία προσεγγίζει αρνητικές τιμές. 
Στο ant colony, επιλέχτηκαν ομοίως τα βάρη, αριθμός επαναλήψεων L = 30 καθώς ο αλγόριθμος είναι αρκετά αργός και απαιτούσαμε πιο άμεσα αποτελέσματα στα tests. Οι τιμές x και y επιλέχτηκαν ως 1.0 και 3.0 αντίστοιχα, γιατί επιτρέπουν στα μυρμήγκια / πράκτορες στον αλγόριθμο να χρησιμοποιήσουν την ευρετική αξιολόγηση χωρίς να αγνοούν πλήρως την αύξηση των pheromones, ώστε να είναι πιο εύκολη η παρακολούθηση των αποτελεσμάτων. Για τον αριθμό μυρμηγκιών χρησιμοποιήθηκε K = 10 για να μην υπάρχει σημαντική καθυστέρηση αλλά να υπάρχουν αρκετές διαφορετικές λύσεις πρακτόρων, και για evaporation rate λ = 0.5 διότι με μικρό βαθμό λ τα pheromones αυξάνονται πιο αργά, ώστε να διατηρούνται προηγουμένως καλές λύσεις και τα μυρμήγκια να είναι πιο αποδοτικά σε επόμενες επαναλήψεις. 


## Μέρος 3 της εργασίας 

Στο μέρος 3, έγιναν τροποποίησεις στους αλγορίθμους του opt_algorithms.cpp ώστε να υπολογίζουν και να επιστρέφουν τον ρυθμό σύγκλισης p. Στο αρχείο ex.cpp, στη main συνάρτηση, λαμβάνεται η σύγκλιση υπόψη και κρίνεται αν θα χρησιμοποιηθεί τυχαιότητα ή όχι. Η τυχαιότητα έχει υλοποιηθεί σύμφωνα με τη γκαουσιανή κατανομή γύρω από το centroid των αμβλυγωνίων τριγώνων : υπολογίζεται με τις συναρτήσεις του std ένα τυχαίο σημείο, και στη main χρησιμοποιείται ο υπολογισμός με βάση το centroid.

Επίσης γίνεται κατηγοριοποίηση της εισόδου, όπως ζητείται, με τη χρήση ενός typedef enum στο ex.cpp.

Έγιναν tests στα πιο απλά και στα πιο περίπλοκα instances που δίνονται στο e-class, που βρίσκονται σε 2 υπο-directories. Η μέθοδος ant colony ήταν η πιο χρονοβόρα και λιγότερο αποδοτική, ενώ για "default" παραμέτρους για τις πιο συχνές κατηγορίες, Α και Ε, καθώς και λιγότερο για τη Β, επιλέχθηκαν βάρη a = 2 και b = 5 ή a = 3 και b = 7 για το simulated annealing, με L = 100 με 300, ενώ για το local search L = 100. Τα αποτελέσματα φαίνονται περισσότερο στο report. 
Υπολογίστηκαν ο αριθμός των αμβλείων γωνίων, τα steiner points που δημιουργήθηκαν, ο ρυθμός σύγκλισης p και ο χρόνος εκτέλεσης του προγράμματος για τα instances.
Για τα αποτελέσματα του διαγωνισμού, δημιουργήθηκε ο φάκελος best_results.
